...
class Task(models.Model):
    ...
    employee = models.ForeignKey(settings.AUTH_USER_MODEL,on_delete=models.PROTECT,related_name='myTasks',blank=False)
...
class Team(models.Model):
    ...
    team_manager_id = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.PROTECT, blank=True, null=True, related_name='managed_teams')
